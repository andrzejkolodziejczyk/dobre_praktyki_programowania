...
from functions import (
    is_palindrome, fibonacci, count_vowels, 
    calculate_discount, flatten_list, word_frequencies, is_prime
)

# 1. Testy is_palindrome
...
def test_word_frequencies():
    ...
    freq = word_frequencies("Ala ma kota, a kot ma Ale.")
    assert freq["ala"] == 1
    assert freq["ma"] == 2
    assert "kota" in freq
